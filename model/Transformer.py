...
class Transformer(nn.Module):
    ...
    def set_embeddings_fuc(self, src_fuc, tgt_fuc, src_size, tgt_size):
        self.encoder.set_extention_emb_fuc(src_fuc, src_size)
        self.decoder.set_extention_emb_fuc(tgt_fuc, tgt_size)
