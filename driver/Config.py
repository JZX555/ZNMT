...
class Configurable(object):
    ...
    @property
    def num_kept_checkpoints(self):
        return self._config.getint('Save', 'num_kept_checkpoints')
    ...
    @property
    def add_position_emb(self):
        return self._config.getboolean('Network', 'add_position_emb')
    ...
    @property
    def src_vocab_type(self):
        return self._config.get('Vocab', 'src_vocab_type')    

    @property
    def tgt_vocab_type(self):
        return self._config.get('Vocab', 'tgt_vocab_type')   

    @property
    def src_vocab_path(self):
        return self._config.get('Vocab', 'src_vocab_path')    

    @property
    def tgt_vocab_path(self):
        return self._config.get('Vocab', 'tgt_vocab_path')   

    @property
    def extention_vocabs_path(self):
        return eval(self._config.get('Vocab', 'extention_vocabs_path'))

    @property
    def extention_embeddings_path(self):
        return eval(self._config.get('Vocab', 'extention_embeddings_path'))

    @property
    def load_extention_vocab(self):
        return self._config.getboolean('Vocab', 'load_extention_vocab')

    @property
    def src_fusion_list(self):
        return eval(self._config.get('Vocab', 'src_fusion_list'))

    @property
    def tgt_fusion_list(self):
        return eval(self._config.get('Vocab', 'tgt_fusion_list'))

    @property
    def extention_embeddings_size(self):
        return eval(self._config.get('Vocab', 'extention_embeddings_size'))