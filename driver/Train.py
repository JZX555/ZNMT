...
def train(nmt, train_srcs, train_tgts, config):
    ...
    for iter in range(config.train_iters):
        ...
        iterator = create_train_batch_iter(nmt.train_data, nmt.batch_size, bacthing_key=config.batching_key, shuffle=False)
